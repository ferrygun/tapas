...
def predict(table_data, queries):
  ...
  lenq= len(queries)
  query = 'python ../tapas/tapas/run_task_main.py --task="SQA"  --output_dir="results" --noloop_predict --test_batch_size={0} --tapas_verbosity="ERROR" --compression_type=  --init_checkpoint="tapas_sqa_base/model.ckpt"   --bert_config_file="tapas_sqa_base/bert_config.json"  --mode="predict" 2> error'.format(lenq)
...
""", ["what were the drivers names?",
      "What is the driver for team Rahal?",
